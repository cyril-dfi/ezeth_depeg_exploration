...
output_csv_filename = f'chainlink_round_data_{network}_{token}.csv'

# Price Feed address
addresses = {
    'ezETH': '0x11E1836bFF2ce9d6A5bec9cA79dc998210f3886d',
...
round_ids = []
rs = {}
rs['ezETH'] = 18446744073709551769
rs['wstETH'] = 18446744073709552039
r = rs[token]
i = 0
while i < 80:
    round_ids.append(r+i)
    i+=1
